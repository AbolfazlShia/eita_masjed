...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull FrameLayout gradientOverlay, @NonNull FragmentContainerView navHostFragment,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      FrameLayout gradientOverlay = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, backgroundImage, bottomNav,
          gradientOverlay, navHostFragment, rootContainer);
    }
